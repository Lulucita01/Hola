...
st.markdown("<h1 style='text-align: center;'>My Pythonexperience</h1>", unsafe_allow_html=True)
...
col1.image("FOTO PERFIL Lu.png", caption='El que tiene miedo a morir que no nazca', width=300)
...
texto = """
Soy Luciana, soy estudiante de la carrera de Periodismo de la Pontificia Universidad Católica del Perú (PUCP) y me encuentro contenta con mi desenvolvimiento en mi carrera actual. Me gusta leer libros de romance ambientados en la época Victoriana (siglos XVII, XVIII), y mi autora favorita es Jane Austen. También me encantan las novelas distópicas y ver series en familia.
"""
...
texto_2 = """
Mi experiencia aprendiendo a programar la podría describir como útil y algo desafiante. Si bien presenté algunos problemas al inicio al tratar de aprender nuevos códigos en una nueva plataforma, al final logré adaptarme y alcancé a tener un gusto por este curso bastante peculiar. Considero que estos conocimientos me servirán para mi carrera y para lo que posteriormente sigue. Al fin y al cabo, todos los conocimientos nuevos son valiosos.
"""
...
sidebar.markdown("<h1 style='text-align: center;'Gráficos aprendidos", unsafe_allow_html=True)
...
graficos = ['Mapa geográfico películas estadounidenses', 'Mapa familias linguísticas', 'Mapa familias aisladas']

# Creamos un cuadro de selección en la barra lateral
grafico_seleccionado = sidebar.selectbox('Selecciona un gráfico a su elección', graficos)
...
if grafico_seleccionado == 'Mapa geográfico películas estadounidenses':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Este gráfico es una representación geográfica de mis películas estadounidenses favoritas, mostrando su locación en base a longitud y latitud</div>", unsafe_allow_html=True)
    sidebar.image("hola.jpg", caption='hola', width=500)
    pass
elif grafico_seleccionado == 'Mapa familias linguísticas':
    sidebar.markdown("<div style='text-align: justify'>Este gráfico representa el mapa de las familias linguísticas de África</div>", unsafe_allow_html=True)
    sidebar.image("mapa_familia_linguistica.jpg", caption='mapa_familia_linguistica', width=500)
    pass
elif grafico_seleccionado == 'Mapa familias aisladas':
    sidebar.markdown("<div style='text-align: justify'>Este gráfico representa el mapa de las familias aisladas de África</div>", unsafe_allow_html=True)
    sidebar.image("papa.jpg", caption='papa', width=500)
    pass
